...
def gen_coord_info_value(
    ...
    elif is_stick_dim and element_arrangement == ElementArrangement.DL16_TO_FP32 and opfunc in ("shuffle", "identity"):
    ...
    def _build_coord_info(op, tensor, tensor_idx: int) -> dict:
        ...
        for dim in dim_order:
            ...
            result[dim_str] = gen_coord_info_value(
                ...
                element_arrangement=getattr(tensor, "element_arrangement", ElementArrangement.STANDARD),
